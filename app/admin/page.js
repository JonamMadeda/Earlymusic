              ...
              <div key={letter} className="mb-2">
                ...
                <div className="flex flex-col gap-y-1">
                  {groupedSongs[letter].map((song, idx) => (
                    <div
                      key={song.id}
                      className="group grid grid-cols-[1fr_auto] md:grid-cols-[1fr_180px_120px_96px] gap-4 items-center rounded-xl border border-transparent bg-white px-2.5 py-2 shadow-sm transition hover:border-neutral-200 hover:shadow-sm md:px-4"
                    >
                      {/* Track */}
